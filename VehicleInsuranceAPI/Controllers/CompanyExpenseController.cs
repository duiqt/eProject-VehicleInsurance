...
namespace VehicleInsuranceAPI.Controllers
{
    ...
    public class CompanyExpenseController : ControllerBase
    {
        ...
        /// <summary>
        /// Get Company Expense Detail by using CEId to find Claim that are approved
        /// </summary>
        /// <param name="CEId"></param>
        /// <returns></returns>
        [HttpGet]
        [Route("GetCompanyExpenseDetail/{CEId}")]
        public IActionResult GetClaimDetail(int CEId)
        {
            ...
            model = (from cer in _db.Certificates
                     ...
                     select new ClaimDetailCompanyExpenseAdminModel
                     {
                         ...
                         VehicleNumber = ver.VehicleNumber,
                         VehicleBodyNumber = ver.VehicleBodyNumber,
                         VehicleEngineNumber = ver.VehicleEngineNumber,
            ...
            return Ok(model.Where(u => u.Id == CEId));
        }
    }
}
